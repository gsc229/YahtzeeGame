...
const setScore = function(arr) {
  ...
  if (
    ...
    console.log(`points: ${pointsAces}`);
    console.log(
      "Here how many child elements above: " +
        document.getElementById("Aces").childElementCount
    );
  } else {
    document.getElementById("use-aces").style.display = "none";
  }
  console.log("Points Aces Above " + pointsAces);
  // <button
  //   onclick="Aces()"
  //   type="submit"
  //   id="use-aces"
...
function showScore(e) {
  ...
  span.appendChild(document.createTextNode(pointsAces));
  ...
  console.log("Points Aces Below " + pointsAces);
  console.log(
    "Here's how many child elements below: " +
      document.getElementById("Aces").childElementCount
  );
  e.preventDefault();
}
